#!/usr/bin/env python
# -*- coding: utf-8 -*-
r"""evaporative_humidifier_auto_refill --

"""
from switchbot.devices.device import Device


class EvaporativeHumidifierAutoRefill(Device):
    """EvaporativeHumidifierAutoRefill

    EvaporativeHumidifierAutoRefill is a Device.
    Responsibility:
    """
    def turn_off(self, ):
...
# coding: utf-8
# End:
# evaporative_humidifier_auto_refill.py ends here
